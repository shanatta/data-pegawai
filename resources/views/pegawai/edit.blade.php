    ...
    <form action="/pegawai/{{ $id }}" method="POST">
        ...
        <div class="my-3 p-3 bg-body rounded shadow-sm">
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input value="{{$pegawai->nama}}" type="text" class="form-control" name='nama' id="nama" required>
                </div>
            </div>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input  value="{{$pegawai->jabatan}}" type="text" class="form-control" name='jabatan' id="jabatan" >
                </div>
            </div>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input  value="{{$pegawai->tgl_lahir}}" type="date" class="form-control" name='tgl_lahir' id="tgl_lahir" required>
                </div>
            </div>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input  value="{{$pegawai->alamat}}" type="text" class="form-control" name='alamat' id="alamat" required>
                </div>
            </div>
